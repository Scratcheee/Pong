...
class PongGame extends SurfaceView implements Runnable {
    ...
    public PongGame(Context context, int x, int y) {
        // Super... calls the parent of the class
        ...
        // Prepare the SoundPool instance depending on the version of Android
    ...
    public void run() {
        ...
        while (mPlaying) {
            ...
            // Make sure timeThisFrame is at least 1 millisecond because
            // accidentally dividing by zero crashes the game
            if (timeThisFrame > 0) {
                // Store the current frame rate in mFPS ready to pass
                // to the update methods of mBat and mBall in the next frame/loop
