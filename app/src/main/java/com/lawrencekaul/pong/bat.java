...
class Bat {
    /*
    These are the member variables (fields), they all have
    the m prefix, they are all private because
    ...
    /*
    These variables are public and final, They can be directly
    accessed by the instance (in PongGame) because they are
    part of the same package but cannot be changed
     */
    ...
    Bat(int sx, int sy) {
        // Bat needs to know the screen horizontal
        // resolution outside of this method
        mScreenX = sx;

        // Configure the size of the bat based on the screen
        // resolution one eighth the screen width
        mLength = mScreenX / 8;
        ...
        mXCoord = mScreenX / 2;
        // The height of the bat of the bottom of the screen
        ...
        // Configure the speed of the bat, This code means the bat
    ...
    // Update the movement state passed in by
    ...
    void update(long fps) {
        ...
        // Update mRect based on the results from the
        // previous code in update
        mRect.left = mXCoord;
